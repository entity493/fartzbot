...
client.on("ready", () => {
  ...
  client.user.setActivity(`Watching ${client.guilds.size} servers`);
});
...
client.on("guildDelete", guild => {
  ...
  client.user.setActivity(`Changed roles to Admin and Mod`);
});
...
client.on("message", async message => {
  ...
  if(command === "kick") {
    // This command must be limited  mods and admins. In this example we just hardcode the role names.
